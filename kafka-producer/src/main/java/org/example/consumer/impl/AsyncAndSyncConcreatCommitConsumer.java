...
public class AsyncAndSyncConcreatCommitConsumer implements MyConsumer {
    ...
    public static void main(String[] args) {
        AsyncAndSyncConcreatCommitConsumer basicConsumer = new AsyncAndSyncConcreatCommitConsumer();
